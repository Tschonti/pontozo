...
export class Redo1683278631422 implements MigrationInterface {
    name = 'Redo1683278631422'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category_to_criterion" ADD CONSTRAINT "FK_f865984330d9c0dd37cfe7afd51" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
