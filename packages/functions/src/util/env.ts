...
export const DB_NAME = env.get('DB_NAME').default('pontozo-prod-copy').asString()
...
export const MTFSZ_API_HOST = env.get('MTFSZ_API_HOST').asString()
...
export const ACS_EMAIL_SENDER = env.get('ACS_EMAIL_SENDER').default('<noreply@pontozo-notification.mtfsz.hu>').asString()
