...
export const REDIS_HOST = env.get('REDIS_HOST').default('').asString()
export const REDIS_PORT = env.get('REDIS_PORT').default(0).asInt()
export const REDIS_PWD = env.get('REDIS_PWD').default('').asString()
