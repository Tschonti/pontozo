...
export class Init1688230862927 implements MigrationInterface {
    name = 'Init1688230862927'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "event_organisers_club" ("eventId" int NOT NULL, "clubId" int NOT NULL, CONSTRAINT "PK_2959ede2ce4ce986bf20bf0efb0" PRIMARY KEY ("eventId", "clubId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "event_organisers_club" ADD CONSTRAINT "FK_af397ed122aee1fcb102f9bd0f0" FOREIGN KEY ("eventId") REFERENCES "event"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "event_organisers_club" ADD CONSTRAINT "FK_27861717dbffadcb3c9f98ae057" FOREIGN KEY ("clubId") REFERENCES "club"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
