...
export class Init1688230862927 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "event" ("id" int NOT NULL, "name" nvarchar(255) NOT NULL, "type" nvarchar(255) NOT NULL, "startDate" nvarchar(255) NOT NULL, "endDate" nvarchar(255), "rateable" bit NOT NULL CONSTRAINT "DF_60718ea2c6e6abd42b982dd321a" DEFAULT 1, "highestRank" nvarchar(255) NOT NULL, CONSTRAINT "CHK_3bb291fa6d94999112e1705565" CHECK (highestRank in('REGIONALIS', 'ORSZAGOS', 'KIEMELT')), CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
