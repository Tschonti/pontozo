...
export class CriterionWeightTable1735293625488 implements MigrationInterface {
  name = 'CriterionWeightTable1735293625488'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "criterion_weight" ("id" int NOT NULL IDENTITY(1,1), "criterionId" int NOT NULL, "seasonId" int NOT NULL, CONSTRAINT "PK_931219b82b601f8cfd132a0e9bc" PRIMARY KEY ("id"))`
    )
